...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(tuple<const char*, const char*>{"sf", "Starfield - Textures01.ba2"},
                    ...
                    // fails with "File packing error: Unsupported uncompressed DDS format" tuple<const char *, const
                    // char *>{"sf", "Starfield - Textures03.ba2"}, // packing this archive fails with "File packing
                    // error: Unsupported uncompressed DDS format"
